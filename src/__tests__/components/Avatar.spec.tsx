...
describe('Avatar Styling', () => {
  ...
  test('style', () => {
    ...
    expect(avatarName).toHaveClass("MuiTypography-root MuiTypography-caption css-l9xrju-MuiTypography-root");

    const avatarDate = screen.getByTestId("avatarDate");
    expect(avatarDate).toBeInTheDocument();
    expect(avatarDate).toHaveClass("MuiTypography-root MuiTypography-small css-19nzuet-MuiTypography-root");
